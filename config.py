...
class Config(object):
    # pyro client config
    API_ID = os.environ.get("API_ID", "25926022")  # ⚠️ Required
    API_HASH = os.environ.get("API_HASH", "30db27d9e56d854fb5e943723268db32")  # ⚠️ Required
    BOT_TOKEN = os.environ.get("BOT_TOKEN", "8060384401:AAHdvscjhExe-Zrt15ldep3VnS-kXIhkuYM")  # ⚠️ Required
    # ... vos configurations existantes
    DESTINATION_CHANNEL = -1002940322923  # ID numérique du canal (avec le -100)
    CHANNEL_ADMINS = [6190227238, 8140299716]  # Liste des IDs des utilisateurs autorisés
    ...
    # database config
    DB_URL = environ.get("DB_URL", "mongodb+srv://Ethan:Ethan123@telegrambots.lva9j.mongodb.net/?retryWrites=true&w=majority&appName=TELEGRAMBOTS")
    DB_NAME = environ.get("DB_NAME", "TELEGRAMBOTS")  # ⚠️ Required

    # other configs
    BOT_UPTIME = time.time()
    START_PIC = os.environ.get("START_PIC", "https://graph.org/file/9c910cbc74144b3b2efce.jpg")
    ADMIN = [int(admin) if id_pattern.search(
        admin) else admin for admin in os.environ.get('ADMIN', '8140299716').split()]  # ⚠️ Required
    
    FORCE_SUB = os.environ.get("FORCE_SUB", "aniflixClou") # ⚠️ Required Username without @
    LOG_CHANNEL = int(os.environ.get("LOG_CHANNEL", "-1002698474966"))  # ⚠️ Required
